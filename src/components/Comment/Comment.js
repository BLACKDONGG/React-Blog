...
class Comment extends Component {
    ...
    async getRatings(){
        ...
        axios.post('thisblog/api/GetRatings',qs.stringify(data))
            .then((response)=>{
                this.setState({
                                    ...
                                    <div className="info">
                                        <div className={`info-wrapper RotateTarget-${ck}`}>
                                            <div className={`info-hook-${ck}`}>
                                                ...
                                                <button disabled={this.state.trigger} type="button" className="icon-add reply" onClick={this.rotateX.bind(this,ck,"","")}>
                                                </button>
                                            </div>
